...
@OperationsPerInvocation(value = WindowAggregationBenchmarks.RECORDS_PER_INVOCATION)
public class WindowAggregationBenchmarks extends BenchmarkBase {
  ...
  public static void main(String[] args) throws RunnerException {
    Options options =
        new OptionsBuilder()
            ...
            .include(".*" + WindowAggregationBenchmarks.class.getCanonicalName() + ".*")
            .build();
  ...
  public void tumblingWindow(TimeWindowContext context) throws Exception {
    IntLongApplications.reduceWithWindowAggregate(
