...
import com.ververica.benchmark.StateBackendBenchmarkBase.StateBackend;
import com.ververica.benchmark.StateBackendBenchmarkBase.StateBackendContext;
import com.ververica.benchmark.WindowWithProcessFunctionBenchmarks.StateAPI;
...
@OperationsPerInvocation(
    value = WindowAggregationWithProcessFunctionBenchmarks.RECORDS_PER_INVOCATION)
public class WindowAggregationWithProcessFunctionBenchmarks extends BenchmarkBase {
  ...
  public static void main(String[] args) throws RunnerException {
    Options options =
        new OptionsBuilder()
            ...
            .include(
                ".*"
                    + WindowAggregationWithProcessFunctionBenchmarks.class.getCanonicalName()
                    + ".*")
            .build();
  ...
  public void tumblingWindow(TimeWindowContext context) throws Exception {
    IntLongApplications.reduceWithProcessFunctionAggregate(
        context.source, TumblingEventTimeWindows.of(Time.seconds(10_000)), context.stateAPI);
    context.execute();
  }
