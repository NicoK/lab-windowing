 ...
 */
public class AggregatingWindowWithProcessFunction<Key, IN, OUT, ACC, ACC_OUT>
    extends KeyedProcessFunction<Key, IN, OUT> implements ResultTypeQueryable<OUT> {

  private static final Logger LOG =
      LoggerFactory.getLogger(AggregatingWindowWithProcessFunction.class);
  ...
  public AggregatingWindowWithProcessFunction<Key, IN, OUT, ACC, ACC_OUT> produces(
  ...
  @SuppressWarnings({"unused", "UnusedReturnValue"})
  public AggregatingWindowWithProcessFunction<Key, IN, OUT, ACC, ACC_OUT> allowedLateness(
      Time lateness) {
  ...
  @SuppressWarnings({"unused", "UnusedReturnValue"})
  public AggregatingWindowWithProcessFunction<Key, IN, OUT, ACC, ACC_OUT> sideOutputLateData(
  ...
  @SuppressWarnings({"unused", "UnusedReturnValue"})
  public AggregatingWindowWithProcessFunction<Key, IN, OUT, ACC, ACC_OUT> triggerMode(
